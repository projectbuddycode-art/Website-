...
writeRoute('work', layout({
  ...
  body: `<section class="inner-hero"><div class="hero-inner"><p class="section-label">PROJECT BUDDY / WORK</p><h1>Systems engineered for real operations.</h1><p>These Project Buddy systems demonstrate custom software development, AI automation, mobile application development, system integration and operational software design.</p></div></section><section class="inner-grid">${projects.map((project) => `<article class="inner-card"><p>${project.type}</p><h2><a href="/work/${project.slug}">${project.name}</a></h2><p>${project.summary}</p><a class="card-link" href="/work/${project.slug}">View project →</a></article>`).join('')}</section>`
}));
...
writeRoute('company', layout({
  ...
  schema: breadcrumb('/company', 'Company'),
    body: `<section class="inner-hero"><div class="hero-inner"><p class="section-label">PROJECT BUDDY / COMPANY</p><h1>We start with the operation, then engineer the system.</h1><p>Project Buddy is a software engineering and custom software development company. We help businesses turn operational problems, product ideas and disconnected workflows into practical software systems.</p></div></section><section class="company-approach"><div class="company-approach-copy"><p class="section-label">01 / HOW WE WORK</p><h2>Business first. Technology second.</h2><p>We understand the business, map the process, architect the system, engineer the software, integrate the required services, deploy the product and continue optimizing the operating layer.</p></div><div class="company-approach-support"><p class="company-support-copy">Project Buddy builds practical software systems by focusing on the operation, not the feature list. This keeps engineering aligned with the real workflows and the people who use the system every day.</p></div></section><section class="company-process" aria-label="Project Buddy process sequence"><div class="process-step active"><span>UNDERSTAND</span></div><div class="process-connector"></div><div class="process-step"><span>MAP</span></div><div class="process-connector"></div><div class="process-step"><span>ARCHITECT</span></div><div class="process-connector"></div><div class="process-step"><span>ENGINEER</span></div><div class="process-connector"></div><div class="process-step"><span>INTEGRATE</span></div><div class="process-connector"></div><div class="process-step"><span>DEPLOY</span></div><div class="process-connector"></div><div class="process-step"><span>OPTIMIZE</span></div></section><section class="company-capabilities"><p class="section-label">WHAT PROJECT BUDDY BUILDS</p><div class="capability-grid">${['Custom Software','Enterprise Applications','Web Applications','Mobile Applications','AI Automation','Business Process Automation','Operational Platforms','Integrated Digital Systems','SaaS Products'].map((item, index) => `<article class="capability-item"><span class="capability-index">0${index + 1}</span><h3>${item}</h3><span class="capability-link">→</span></article>`).join('')}</div></section>`
}));
...
writeRoute('404', layout({
  ...
  body: `<section class="inner-hero"><div class="hero-inner"><p class="section-label">PROJECT BUDDY / 404</p><h1>This page is outside the system map.</h1><p>The route you requested could not be found. Return to the homepage or explore Project Buddy services and work.</p><a class="button primary" href="/">Return Home →</a></div></section>`
}));
